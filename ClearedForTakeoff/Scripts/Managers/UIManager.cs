...
public class UIManager
{
    ...
    public void Draw(SpriteBatch spriteBatch, int fps, Vector2 screenPos, Vector2 worldPos, string _clicked)
    {
        spriteBatch.Begin();
        ...
        spriteBatch.DrawString(_font, _clicked, new Vector2(5, 65), Color.Yellow);
        spriteBatch.End();
    }
}
